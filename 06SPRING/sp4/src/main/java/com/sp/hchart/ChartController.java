...
public class ChartController {
	...
	@RequestMapping(value="/hchart/pie", produces="application/json;charset=utf-8")
	@ResponseBody
	public String pie3d() throws Exception{
		...
		ja.put(new JSONArray("['07-10',10]"));
		ja.put(new JSONArray("['10-13',30]"));
		ja.put(new JSONArray("['13-16',33]"));
		ja.put(new JSONArray("['16-19',20]"));
