...
<body>
   <div class="container">
      ...
      <div class="panel panel-default">
         <div class="panel-body">서울 마포구 월드컵북로 21 2층 풍성빌딩 지번서울 마포구 서교동 447-5
         <button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModal02">Map</button>
         <button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModal03">Admin</button>
         </div>
      </div>
      <%=message2 %>
      <div class="panel panel-default">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <script>
            function myMap() {
               var mapProp = {
                  center : new google.maps.LatLng(37.556458, 126.921455),
                  zoom : 17
               };
               ...
               var marker = new google.maps.Marker(
                     {
                        position : new google.maps.LatLng(37.556553,
                              126.919499)
                     });
               marker.setMap(map);
